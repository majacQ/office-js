...
/* osfweb version: 16.0.15924.10000 */
/* office-js-api version: 20221204.2 */
/*
...
(function (OSFAppTelemetry) {
    ...
    function initialize(context) {
        ...
        appInfo.hostJSVersion = "16.0.15924.10000";
...
function getSensitivityLabelsCatalog() {
  ...
  var commonParameters = parseCommonArgs(args, true, false);
  standardInvokeHostMethod(199, commonParameters.asyncContext, commonParameters.callback, undefined, sensitivityJsonConverter);
}
function sensitivityJsonConverter(rawInput) {
  var sensitivities = [];

  if (rawInput !== null) {
    rawInput.forEach(function (element) {
      var parsedElement = JSON.parse(element.toString());
      var sensitivityLabel = {
        id: parsedElement.id,
        nameInvariant: parsedElement.nameInvariant,
        name: parsedElement.name,
        children: parsedElement.children ? sensitivityJsonConverter(JSON.parse(parsedElement.children)) : null,
        color: parsedElement.color,
        tooltip: parsedElement.tooltip
      };
      sensitivities.push(sensitivityLabel);
    });
  }
