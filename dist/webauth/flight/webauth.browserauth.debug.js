...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CheckUpnMatchIdToken = exports.GetApplication = exports.GetTokenOnce = exports.GetToken = exports.Load = exports.MsalWrapper = exports.SsoSilentWrapper = exports.applications = exports.msalInstance = exports.ValidateUtils = exports.LoggingUtils = exports.ExtractUtils = exports.Constants = void 0;
...
Object.defineProperty(exports, "ExtractUtils", { enumerable: true, get: function () { return ExtractUtils_1.ExtractUtils; } });
...
Object.defineProperty(exports, "LoggingUtils", { enumerable: true, get: function () { return LoggingUtils_1.LoggingUtils; } });
...
Object.defineProperty(exports, "ValidateUtils", { enumerable: true, get: function () { return ValidateUtils_1.ValidateUtils; } });
...
function Load(configurations, correlationId) {
    ...
    return MsalWrapper((authConfig.timeoutToLoad) ? authConfig.timeoutToLoad : 2000).then(function (msalInstance) {
        ...
        var defaultAppId;
        for (var _i = 0, _b = authConfig.appIds; _i < _b.length; _i++) {
            var appId = _b[_i];
        ...
        var promises = [];
        (_a = authConfig.prefetch) === null || _a === void 0 ? void 0 : _a.forEach(function (target) {
            var prefetch = SsoSilentWrapper(defaultAppId, authConfig.upn, isMsa ? Constants_1.Constants.Authority.MsaSuffix : Constants_1.Constants.Authority.AadSuffix, [ValidateUtils_1.ValidateUtils.getScope(target ? target : Constants_1.Constants.Authority.DefaultTarget)], correlationId);
            promises.push(prefetch);
        });
        return Promise.all(promises).then(function (ssoResults) {
