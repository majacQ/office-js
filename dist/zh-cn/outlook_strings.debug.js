...
_u.ExtensibilityStrings.l_NativeLabelingNotEnabled_Text = "未启用敏感度标签。";
...
_u.ExtensibilityStrings.l_UserHasNoLabelsToSet_Text = "用户没有要设置的标签。";
...
_u.ExtensibilityStrings.l_FailedToSetLabel_Text = "无法设置敏感度标签。";
_u.ExtensibilityStrings.l_API_Not_Supported_For_Shared_Folders_Error = "共享文件夹不支持 API。";
_u.ExtensibilityStrings.l_SensitivityUnableToSetParent_Text = "无法设置具有子级的敏感度。";
...
_u.ExtensibilityStrings.l_FailedToGetLabelsCatalog_Text = "无法获取敏感度标签目录。";
_u.ExtensibilityStrings.l_FailedToGetLabel_Text = "无法获取敏感度标签。";
