...
Strings.OfficeOM.L_InvalidObjectPath = 'Objektsökvägen {0} fungerar inte för det du försöker göra. Om du använder objektet i flera "context.sync"-anrop och utanför den sekventiella körningen av en ".run"-batch använder du metoderna "context.trackedObjects.add()