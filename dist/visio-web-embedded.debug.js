...
// Sources:
// osfweb: 16.0\16.0.16121.10000
// runtime: 16.0\16.0.16121.10000
// core: 16.0\16.0.16121.10000
// host: 16.0\16.0.16121.10000
...
(function (OfficeCore) {
    ...
    var Auth = (function (_super) {
        ...
        Object.defineProperty(Auth.prototype, "_className", {
            get: function () {
                return "Auth";
            },
            enumerable: true,
        ...
        Auth.prototype.getAccessTokenFirstPartyOAuth = function (appName, target) {
            return _invokeMethod(this, "GetAccessTokenFirstPartyOAuth", 1, [appName, target], 4 | 1, 0);
        };
        Auth.prototype._handleResult = function (value) {
            _super.prototype._handleResult.call(this, value);
            if (_isNullOrUndefined(value))
                return;
            var obj = value;
        ...
        Auth.prototype._handleRetrieveResult = function (value, result) {
            _super.prototype._handleRetrieveResult.call(this, value, result);
            _processRetrieveResult(this, value, result);
        };
        Auth.newObject = function (context) {
            return _createTopLevelServiceObject(OfficeCore.Auth, context, "Microsoft.Office.Auth", false, 1 | 4);
        };
